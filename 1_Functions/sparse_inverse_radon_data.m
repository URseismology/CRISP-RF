function [mk1,filteredRF] = sparse_inverse_radon_data(d, dt, rayP, dist, timeshft, q, ...
...
taus = (0:1:nt-1) * dt + twin(1); %generate taus scaled by the sample time
...
% get diagonal mask
[Kmask, qps_q] = KdiagMask(m0', taus + timeshft, q, H, Vp, Vs, 2);
Kmask = Kmask';
